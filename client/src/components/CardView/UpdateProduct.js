        ...
        <div>
            <Box style={{margin:"50px 100px"}}>
                ...
                <FormControl style={{marginTop:"15px",display:"flex",flexDirection:"row"}}>
                    ...
                    <InputBase style={{flex:"1",margin:"0px 30px",fontSize:"18px",fontWeight:700,fontFamily:'Times New Roman'}} value={post.title}
                    ...
                    <InputBase style={{flex:"1",margin:"0px 30px",fontSize:"18px",fontWeight:700,fontFamily:'Times New Roman'}} value={post.tagline}
                    onChange={(e) => handleChange(e)}  name="tagline" placeholder="Tagline"/>
                     <InputBase type="number" style={{flex:"1",margin:"0px 30px",fontSize:"18px",fontWeight:700,fontFamily:'Times New Roman'}} value={post.quantity}
                    ...
                    <InputBase type="number" style={{flex:"1",margin:"0px 30px",fontSize:"18px",fontWeight:700,fontFamily:'Times New Roman'}} value={post.mrp}
                    onChange={(e) => handleChange(e)}  name="mrp" placeholder="Original MRP Price "/>
                   <InputBase type="number" style={{flex:"1",margin:"0px 30px",fontSize:"18px",fontWeight:700,fontFamily:'Times New Roman'}} value={post.cost}
                    onChange={(e) => handleChange(e)}  name="cost" placeholder="Cost Price"/>
                    </FormControl>
                <TextareaAutosize  minRows={5} onChange={(e) => handleChange(e)}  name="description" placeholder="Add description" value={post.description}
